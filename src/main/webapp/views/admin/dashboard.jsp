...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        ...
        <!-- System Info Card -->
        <div class="mt-6 bg-gradient-to-r from-gray-700 to-gray-900 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-lg font-bold">System Information</h3>
                        <p class="text-sm text-gray-300">University Club Management System v1.0</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-sm text-gray-300">Admin Access Level</p>
                    <p class="text-lg font-bold">Full Control</p>
                </div>
            </div>
        </div>
    </div>
